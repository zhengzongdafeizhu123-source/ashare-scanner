...
P15_RECENT_METADATA = {
    "hardpass_high_score": {
        ...
        "d2_tag": "确认后别追过高开",
        "d2_note": "默认仍偏向按 D2 收盘理解。若改用确认后再买的读法，D2 开盘若已高于 breakout 约 2% 以上，通常就不适合再追。",
    },
    "hardpass_space_turnover": {
        "recent_sort_bias": 0,
        ...
        "d2_tag": "确认后别追过高开",
        "d2_note": "当前默认仍偏向按 D2 收盘理解。若走确认后再买，D2 开盘若已经明显高于 breakout，通常不适合继续追高。",
    },
    "hardpass_core": {
        "recent_sort_bias": -1,
        ...
        "d2_tag": "确认后更别追高开",
        "d2_note": "退出仍默认偏向 D2 收盘。若 D1 只是勉强确认，D2 开盘一旦已高于 breakout 约 2% 以上，就要格外谨慎。",
    },
    "candidate_continuation": {
        "recent_sort_bias": 2,
        ...
        "d2_tag": "确认后别追高开",
        "d2_note": "当前这条线默认仍按 D2 收盘理解。若改成确认后再买，D2 开盘若已高于 breakout 约 2% 以上，后续剩余空间通常会明显变差。",
    },
    "candidate_secondary_core": {
        "recent_sort_bias": 0,
        ...
        "d2_tag": "确认后更别追高开",
        "d2_note": "只有当 D1 真正确认并站稳 breakout 后，D2 才能按主线节奏理解。即便如此，若 D2 开盘已高于 breakout 约 2% 以上，追价质量通常也会明显变差。",
    },
    "watch_repair": {
        "recent_sort_bias": -6,
        ...
        "d2_tag": "弱修复别追高开",
        "d2_note": "如果 D2 本身仍缺乏强确认，更适合快看快走，不适合延长持有。若走确认后再买，也应避免去追已经明显拉高的 D2 开盘。",
    },
}
...
DEFAULT_P15_RECENT_METADATA = {
    ...
    "d2_tag": "确认后别追高开",
    "d2_note": "若 D1 缺乏强确认，D2 更应偏谨慎而不是盲目延续。即便已经确认，也应避免去追已经明显拉高的 D2 开盘。",
}
